...
ALTER TABLE [AuthIdentityUserMasters] ADD CONSTRAINT [FK_AuthIdentityUserMasters_UserMaster_Amt_UmtUserCode] FOREIGN KEY ([Amt_UmtUserCode]) REFERENCES [UserMaster] ([UmtUserCode]) ON DELETE NO ACTION;
