...
ALTER TABLE [AuthIdentity] ADD CONSTRAINT [FK_AuthIdentity_T_UserMaster_UmtUserCode] FOREIGN KEY ([UmtUserCode]) REFERENCES [T_UserMaster] ([Umt_UserCode]) ON DELETE NO ACTION;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20170916052958_changedRelationshipinAuthIdentityClass', N'1.1.2');
