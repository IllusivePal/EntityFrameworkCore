...
CREATE TABLE [AuthIdentityMaster] (
    ...
    CONSTRAINT [FK_AuthIdentityMaster_UserMaster_Amt_UmtUserCode] FOREIGN KEY ([Amt_UmtUserCode]) REFERENCES [UserMaster] ([UmtUserCode]) ON DELETE NO ACTION
);
...
CREATE TABLE [HistoryTableMaster] (
    ...
    CONSTRAINT [FK_HistoryTableMaster_ProductMaster_ProductMasterPmt_ProductCode] FOREIGN KEY ([ProductMasterPmt_ProductCode]) REFERENCES [ProductMaster] ([Pmt_ProductCode]) ON DELETE NO ACTION,
    CONSTRAINT [FK_HistoryTableMaster_UserMaster_UserMasterUmtUserCode] FOREIGN KEY ([UserMasterUmtUserCode]) REFERENCES [UserMaster] ([UmtUserCode]) ON DELETE NO ACTION
);
...
VALUES (N'20170919061354_RenameTableRevision', N'1.1.2');
